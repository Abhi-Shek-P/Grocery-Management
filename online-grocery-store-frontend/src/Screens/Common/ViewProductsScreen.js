    ...
    return (
        <div className="Screen">
            ...
            <div className="row">
                                ...
                                <div className="card">
                                    <div className="card-body text-center">
                                         
                                        {
                                            ...
                                            <img src={`${detail.product.imageName}`} loading= "lazy" decoding="async" alt="productimage" className="img-fluid productImage"/>
                                        ...
                                        <div className="card-title"> <h5>{detail.product.name}</h5> </div>
                                        
                                        <div className="card-text">
                                            <h6>{detail.product.price} &#8377; / {detail.stock.unit} </h6>
                                            <hr/>
                                            <div className="row">
                                                <div className="col-md-3 Block stockData">{detail.stock.quantity} {detail.stock.unit}</div>
                                                <div className="col-md-4 Block" id="Edit"><button onClick={() => {onEdit(detail)}} className="btn btn-info">Edit</button></div>
                                                <div className="col-md-4" id="Delete"><button onClick={() => {onDelete(detail.product.id, detail.category)}} className="btn btn-outline-danger">Delete</button></div>
                                            </div>
                                        </div>
                ...
                <div className="col-md-3 col-sm-6 col-xs-12 myCardElement addProductCard" onClick={() => {nav("/add-product")}}>
                    <div className="card">
                        <div className="card-body text-center">
                            <br/><br/>
