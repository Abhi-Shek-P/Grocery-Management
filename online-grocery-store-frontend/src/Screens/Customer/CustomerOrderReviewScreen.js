            ...
            <div className="row">
                <div className="col-md-6 Block parent-block">
                    ...
                    <div id="order-action-block">
                        <button className="btn btn-outline-info" onClick={()=>{nav("/customer-products")}}>Continue Shopping</button>
                ...
                <div className="col-md-6">
                    ...
                    }
                    {
                        ...
                        <div className="col-md-6 col-sm-6 col-xs-12 myCardElement addCard" onClick={() => {nav("/add-address")}}>
                            <div className="card">
