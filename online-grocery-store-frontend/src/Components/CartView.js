...
const CartView = (props) => {
    ...
    const onCheckOut =() => {
        if(cart.length>0){
            return nav("/order-review");
        }
        return nav("/customer-products");
                ...
                <div className="full-height row">
                    ...
                    <div className="col-md-3">
                                            ...
                                            <div className="row">
                                                <div className="col-md-3">
                                                    <span className="vertical-aligner"></span>
                                                    {
                                                                ...
                                                                <img src={url_image + `/${item.selectedProduct.imageName}`} alt="product" className="img-fluid img-thumbnail"/>
                                                            }
                                                            {
                                                                !item.selectedProduct.imageName &&
                                                ...
                                                <div className="col-md-9">
                                                    ...
                                                    <div className="cart-item-body">
                                                        ...
                                                        <span className="float-end"> &#8377; {item.selectedProduct.price * item.quantity} </span>
                        ...
                        <div className="check-out text-center">
                            ...
                            <div onClick={onCheckOut} className="btn btn-warning check-out-btn" >
