    ...
    <div>
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark myNav">
        <div className="container-fluid">
          <Link className="navbar-brand" id="brand" to="/">Groceteria</Link>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                  <Link className="nav-link " aria-current="page" to="/admin-home"> Home</Link>
                </li>
                <li className="nav-item">
              ...
              <div className="d-flex">
                <button onClick={onLogOut} className="btn btn-outline-success" type="button" >Logout</button>
              </div>
            </div>
            )
          }
          {   
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <Link className="nav-link " to="/employee-home">Home</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/edit-profile"> Edit Profile </Link>
                        </li>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                 ...
                 <div className="d-flex">
                    <div className="cartArea" onClick={() => {cartClicked()}}>                        
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#e6b400" className="bi bi-cart-fill text-info" viewBox="0 0 16 16">
              ...
              {   
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <Link className="nav-link " to="/delivery-home">Home</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/edit-profile"> Edit Profile </Link>
                        </li>
